...
import Video from "./video_banner/video.js";
import TopGame from "./TopGames/topgame";
import Recommen from "./Recommen/recommen";
import Hot from "./Hot/hot"
import ProTeam from "./Proteam/proteam";
import CateLive from "./catelives/catelives";
...
export default function Home() {
    ...
    return (
        <div>
            <div className={style.nimo__banner}>
                <Video />
            </div>
            
            <div className={style.nimo__main}>

                <div className={style.nimo__main_group}>
                    <TopGame />
                    <Recommen />
                    <Hot />
                    <ProTeam/>
